...
public class Tests {
    ...
    public void test(int a, int b, int c) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        String feedbackBuilder = Translator.translate("La mediane entre {0}, {1} et {2} vaut {3}, or votre programme calcule {4}.\n");
        String feedback = MessageFormat.format(feedbackBuilder, a, expected, reponse_etudiant);
        assertTrue(MessageFormat.format(feedbackBuilder, a, b, c, expected, reponse_etudiant), expected == reponse_etudiant);
    }
