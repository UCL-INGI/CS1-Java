	...
	private class t1 implements Callable<Void> {
		...
		public Void call(){
			...
			try {
				...
				String feed = MessageFormat.format(Translator.translate("{0} : vous devez utiliser les méthodes getNum() et getDen() pour récupérer les valeurs des variables d''instances !"), test_name());
				fail(feed);
				return null;
			}
		}
