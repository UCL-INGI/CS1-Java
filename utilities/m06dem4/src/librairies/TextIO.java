...
public class TextIO {
    ...
    */
   public static char getAnyChar() throws EOFException { 
		return readChar(); 
   }
    ...
    * standard input.)
    */
   public static void skipBlanks() throws EOFException { 
      char ch=lookChar();
    ...
    * standard input.)
    */
   private static void skipWhitespace() throws EOFException {
      char ch=lookChar();
    ...
    */
   public static byte getlnByte() throws EOFException { 
      byte x=getByte(); 
      emptyBuffer(); 
      return x; 
   }
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static short getlnShort()throws EOFException {
      short x=getShort();
      emptyBuffer(); 
      return x; 
   }
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static int getlnInt()throws EOFException { 
      int x=getInt(); 
      emptyBuffer(); 
      return x; 
   }
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static long getlnLong()throws EOFException {
      long x=getLong(); 
      emptyBuffer(); 
      return x;
   }
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static float getlnFloat()throws EOFException {
      float x=getFloat(); 
      emptyBuffer(); 
      return x;
   }
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static double getlnDouble() throws EOFException{ 
      double x=getDouble(); 
      emptyBuffer(); 
      return x; 
   }
    ...
    */
   public static char getlnChar() throws EOFException{
      char x=getChar(); 
      emptyBuffer(); 
      return x;
   }
    ...
    */
   public static boolean getlnBoolean() throws EOFException { 
    ...
    */
   public static String getlnWord() throws EOFException {
      String x=getWord(); 
      emptyBuffer(); 
      return x; 
   }
    ...
    */
   public static String getlnString() throws EOFException {
      return getln();
   } 
    ...
    */
   public static String getln() throws EOFException {
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static byte getByte()  throws EOFException { 
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static short getShort() throws EOFException { 
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static int getInt() throws EOFException { 
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static long getLong() throws EOFException  { 
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static float getFloat() throws EOFException {
      float x = 0.0F;
      while (true) {
    ...
    * is input.  In other cases, an IllegalArgumentException will be thrown if a legal value is not found.
    */
   public static double getDouble() throws EOFException {
      double x = 0.0;
      while (true) {
         String str = readRealString();
         if (str == null) {
    ...
    * if an end-of-file is encountered.
    */
   public static String getWord() throws EOFException {
      skipWhitespace();
    ...
    * must be one of these; note that the "word"  must be terminated by a whitespace character (or end-of-file).
    */
   public static boolean getBoolean() throws EOFException {
      boolean ans = false;
      while (true) {
         String s = getWord();
   ...
   private static String readRealString() throws EOFException{   // read chars from input following syntax of real numbers
      skipWhitespace();
      if (lookChar() == EOF)
         return null;
   ...
   private static String readIntegerString()throws EOFException {  // read chars from input following syntax of integers
      skipWhitespace();
      if (lookChar() == EOF)
         return null;
   ...
   private static long readInteger(long min, long max)throws EOFException {  // read long integer, limited to specified range
      long x=0;
      while (true) {
   ...
   private static void errorMessage(String message, String expecting) throws EOFException {  // Report error on input.
   ...
   private static char readChar() throws EOFException {  // return and discard next character from input
      char ch = lookChar();
      if (buffer == null) {
         if (readingStandardInput)
