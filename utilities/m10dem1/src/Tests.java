...
public class Tests{
    ...
    public String feedbackOut = Translator.translate("vérifiez l'output sur la sortie standard (stdOut).\n");
    public String feedbackErr = Translator.translate("vérifiez l'output sur la sortie d'erreur standard (stdErr).\n");
	...
	int r2 = 0;
	String feedback  = MessageFormat.format(Translator.translate("la division par 0 ne donne pas le résultat attendu : \n"), r1, r2);
	...
	String feedback  = MessageFormat.format(Translator.translate("le parsing d''un String composé de lettres ne donne pas le résultat attendu : \n"), r1, r2);
