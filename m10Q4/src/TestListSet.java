...
public class TestListSet {
	...
	private String preQ4 = "@4 :\n";

	private String currentPre = preQ4;
	...
	public void test_2(){ 
		...
		catcher(new TestSet(e, r.nextInt(10), r.nextInt(15) + 10), 1); // dans le tableau 
	}
	
	// On test le set d'un élément à un index présent dans le tableau;
	@Test 
	public void test_1(){ 
		Random r = new Random(); 
		Etudiant e = new Etudiant();
		...
		catcher(new TestSet(e, r.nextInt(10), 36), 1); // On ajoute 36 à un indice random dans le tableau
	}

	private class TestSet implements Callable<Void> {
		int a; // index de set
		Object o; 
		Etudiant l;
		public TestSet(Etudiant liste, int a, Object o){
			this.l= liste;
			this.a = a;
			this.o = o;
		}
