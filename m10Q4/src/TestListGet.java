	...
	private class TestGet implements Callable<Void> {
		...
		public Void call() { 
			...
			try{
			    ...
			    fail("@2 :\n" + Translator.translate("votre méthode get() tente d'accéder à un index hors de l'AList ! Pensez à regarder les pré-conditions.\n"));
			}catch(Exception e){
			    fail("@2 :\n" + Translator.translate("votre méthode get() lance une exception ("+ e +") ! Vérifiez que vous gérez tous les cas possibles.\n"));
			}
			return null;
		}
	}
