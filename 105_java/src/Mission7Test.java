...
public class Mission7Test
{
	...
	{
		article = StudentCode.Article.class;
		facture = StudentCode.Facture.class;
		articleReparation = StudentCode.ArticleReparation.class;
		piece = StudentCode.Piece.class;
		articlePiece = StudentCode.ArticlePiece.class;
	...
	public void facture_getNombre() throws Throwable
	{
		...
		checkConstructor(facture, String.class, Class.forName("[LStudentCode.Article;"));
