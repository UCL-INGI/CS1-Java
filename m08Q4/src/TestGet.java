...
public class TestGet {
	...
	public TestGet(String rn, int arg, int res) {
		this.bs = new ByteString();
		this.bs.setSb(new StringBuilder(reverse(rn)));
		this.arg = arg;
		this.res = res;
	}
	...
	public void test() {
		String pre = "@3 :\n";
		try {
			String msg = "@3 :\n" + _("Test 3 : lorsque l''on exécute votre méthode getBit({0}) sur le ByteString dont la représentation naturelle est {1}, votre code renvoie {2} au lieu de {3}.");
