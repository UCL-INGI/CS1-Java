...
public class TestRotate {
	...
	public void test() {
		...
		try {
			...
			String msg = "@3 :\n" + Translator.translate("Test 7 : lorsque l''on exécute votre méthode rotateRight() sur le ByteString {0}, la chaîne devient {1} au lieu de {2}") + "\n";
			String feed = MessageFormat.format(msg,input,res,expected);
			assertTrue(feed,res.equals(expected));
