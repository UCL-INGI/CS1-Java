...
public class TestParam {
	...
	public void test() {
		try {
			String msg = Translator.translate("Test 2 : lorsque l''on exécute votre code avec le directeur {0} par rapport à l''objet {1}, votre code renvoie {2} au lieu de {3}");
			String feed = MessageFormat.format(msg,d1,d2,d1.equals(d2),res);
			assertTrue(feed,d1.equals(d2) == res);
