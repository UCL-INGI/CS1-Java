...
public class Tests {
    private String msgFeedback = Translator.translate("Le calcul d''intérêts avec une base de {0,number,#} sur {1,number,#} années au taux d''intérêt {2,number,#} donne {3,number,#} mais votre programme calcule {4,number,#}.\n");
