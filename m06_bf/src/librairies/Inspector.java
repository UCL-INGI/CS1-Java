...
public class Inspector {
	 ...
	 * Float.class
	 */
	public static Object run_construct_specified(Class c,String n,float s) {
		try {
			Class [] paramType = new Class[] {String.class, float.class};
			Constructor ctor = c.getConstructor(paramType);
			return ctor.newInstance(new Object[]{n,s});
