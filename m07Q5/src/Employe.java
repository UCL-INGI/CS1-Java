...
public class Employe{
   ...
   public double getSalaire() { 
	   return getRealSalaire();
	}

   /**
	* Cette méthode ne doit pas être montrée aux étudiant. Elle est utilisée
	* pour tester qu'ils appellent bien super.getSalaire();
	*/
   public double getRealSalaire() {
	   return this.salaire;
   }
   /*
