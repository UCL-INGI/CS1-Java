...
public class TestSet {
	...
	public void test() {
		...
		try {
			...
			String msg = Translator.translate("Test 2 : lorsque l''on appelle votre méthode setBit({0}) avec comme byte {1} (représentation en String), le byte devient {2} au lieu de {3}");
