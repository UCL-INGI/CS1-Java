...
public class TestCode {
	...
	private class t1 implements Callable<Void> {
		...
		public Void call() {
			...
			Point spy1 = Mockito.spy(p1);
			Point spy2 = Mockito.spy(p2);
			...
			try {
				double res = spy1.distance(spy2);
				verify(spy1,atLeast(1)).getX();
				verify(spy1,atLeast(1)).getY();

				verify(spy2,atLeast(1)).getX();
				verify(spy2,atLeast(1)).getY();
				return null;
